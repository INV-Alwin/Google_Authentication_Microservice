...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.StartGoogleAuth = channel.unary_unary(
                '/auth.AuthService/StartGoogleAuth',
                request_serializer=auth__pb2.GoogleAuthRequest.SerializeToString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StartGoogleAuth': grpc.unary_unary_rpc_method_handler(
                    servicer.StartGoogleAuth,
                    request_deserializer=auth__pb2.GoogleAuthRequest.FromString,
...
class AuthService(object):
    ...
    def StartGoogleAuth(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/StartGoogleAuth',
            auth__pb2.GoogleAuthRequest.SerializeToString,
